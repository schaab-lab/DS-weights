function fig_theta_grid_rho_grid(rho,dW,Xi_AE,Xi_RS,Xi_IS,Xi_RD,optfig)
...
if optfig.plotfig == 1
    ...
    name = 'app1_welfare_decomp_rho_grid_s0_L_theta_grid';
    print(f1,'-depsc','-painters','-noui','-r600', [folder,name,'.eps'])

    name = 'app1_welfare_decomp_rho_grid_s0_H_theta_grid';
